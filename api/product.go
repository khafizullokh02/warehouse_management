...
type updatePoductRequset struct {
	Name           string  `json:"name" binding:"required,alphanum"`
	SupCode        string  `json:"sup_code" binding:"required,gte=5"`
	BarCode        string  `json:"bar_code" binding:"required,gete=5"`
	Image          string  `json:"image" binding:"required,gte=0"`
